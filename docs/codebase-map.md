...
- [shared/src/people.ts](/home/pi/cairn/shared/src/people.ts)
  ...
  - `UpdatePersonProfileRequestSchema` — full-replacement profile body. Schema validates shape only; server enforces cross-field refinements: preferred/unavailable overlap → 400, half-empty windows (weekdays without periods or vice versa) → 400, invalid channel/leadTimeDays → 400.

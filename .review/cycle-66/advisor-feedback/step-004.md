...
Genuine cycle-66 advisor invocations were two, both saved:
- step-001 — approach review (schema, read-only helper, nodeClass, CSS drift)
- step-002 — completion review (read-only backend, single-mode focus, scope)
